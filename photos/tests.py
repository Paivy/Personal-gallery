...
#         self.new_picture = Image(image='images/picture.jpeg', imageName='Image title', image_description='sth random', image_category=self.new_category, image_location=self.new_location)
#         self.new_picture.save_image()
#         self.another_picture = Image(image='images/photo.jpg', image_name='Another title', image_description='sth else more random', image_category=self.new_category, image_location=self.new_location)
...
#         print(obtained_image.image_name)

#     def test_search_image(self):
#         '''
#         test method to ensure correct searching of an multiple image instances by category
#         '''
#         obtained_image = Image.search_images(self.new_picture.image_category)
...
#         '''
#         obtained_image = Image.filter_by_location(self.another_picture.image_location)
